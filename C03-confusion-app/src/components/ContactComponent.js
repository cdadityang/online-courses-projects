...
const maxLength = (len) => (val) => !(val) || (val.length <= len); // Will return true or false. If chars < 15 - true or else true
const minLength = (len) => (val) => val && (val.length >= len); // If chars < 3 returns false
...
class Contact extends Component{
  ...
  handleSubmit(values){
    ...
    alert("Current State is: " + JSON.stringify(values.firstname));
          ...
          <div className="col-sm-12 col-md-9">
            <Form model="feedback" onSubmit={ (values) => this.handleSubmit(values) }>
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  <Control.text model=".telnum" className="form-control" id="telnum" name="telnum" placeholder="Telephone Number..." 
                    validators={{
                      required, minLength: minLength(3), maxLength: maxLength(15), isNumber: isNumber
                    }}/>
                  <Errors
                    className="text-danger"
                    model=".telnum"
                    ...
                    messages={{
                      ...
                      isNumber: 'Must include only numbers'
                    }}
                    />
                </Col>
              </Row>
              ...
              <Row className="form-group">
                ...
                <Col md={10}>
                  <Control.textarea model=".message" rows="12" id="message" name="message" placeholder="Your Feedback..." className="form-control" />
                </Col>
              </Row>
